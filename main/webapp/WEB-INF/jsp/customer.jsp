...
<%@ taglib prefix="tag" uri="http://peng.com/common/"%>
<%
...
<body>
<%-- <%=basePath %>输出为:http://localhost:80/Spring8610_crm/ --%>
	<div id="wrapper">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<tag:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				...
				data:{"id":id},
				success:function(data) {//后面的是传递回来的值,前面的是本地属性
