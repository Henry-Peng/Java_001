...
public class PersonTest {
	...
	public static void main(String[] args) {
		...
		NewObjectValue nnn = new NewObjectValue();//跟NewObjectValue里面新建的对象地址一样,显示地址是因为没有设置toString;
		System.out.println(nnn);//输出是地址,原代码里面没有设置toString
		System.out.println(per);//输出是字符串值,设置了toString
